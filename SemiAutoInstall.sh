...
if [ -z "$config_prefix" ]
then
      config_prefix="WG_VPN"
fi

echo ""
echo "Enter base subscription monthly price in USDT(TRC20):"
...
git clone https://github.com/AlKarmik/wireguard-bot.git
